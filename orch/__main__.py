...
def main():
    ...
    if args.command.startswith('pilot-'):
        ...
        if args.command in ('pilot-run', 'pilot-abandon') and (not args.expected_sha256 or args.expected_revision is None):
        ...
        try:
            ...
            pilot = Pilot(args.data, read_only=args.command == 'pilot-inspect')
