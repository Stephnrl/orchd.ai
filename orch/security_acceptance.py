...
CRITERIA = (
    {"id": "SEC-01",
     ...
     "offline": ("test_workflow.WorkflowTests.test_state_matrix",
                 ...
                 "test_dispatch.FetchTests.test_a_fetch_reads_and_does_not_write",
                 "test_dispatch.FetchTests.test_a_read_may_not_leave_the_credential_s_origin",
                 "test_dispatch.WholeLoopTests.test_a_capture_from_another_plan_is_refused_before_anything_is_written",
                 "test_github_issue_journal.IssueJournalTests.test_a_pull_request_envelope_cannot_approve_an_issue",
                 "test_github_issue_journal.IssueJournalTests.test_an_issue_envelope_cannot_approve_a_pull_request",
                 "test_github_issue_journal.IssueJournalTests.test_a_reservation_is_consumed_exactly_once",
                 "test_github_issue_journal.IssueJournalTests.test_an_approval_is_refused_once_the_reservation_is_consumed",
                 "test_agent_work.AgentWorkTests.test_an_agent_that_has_not_claimed_the_task_cannot_write_to_it",
                 "test_agent_work.AgentWorkTests.test_one_agent_cannot_write_to_a_task_another_is_holding",
                 "test_agent_work.AgentWorkTests.test_holding_one_task_is_no_licence_to_write_to_another",
                 "test_agent_work.AgentWorkTests.test_an_expired_lease_stops_the_work_it_was_holding",
                 "test_agent_work.AgentWorkTests.test_no_route_an_agent_can_call_confirms_or_answers",
                 "test_agent_work.AgentWorkTests.test_a_confirmed_specification_is_beyond_the_agent_that_wrote_it",
                 "test_agent_sessions.AgentSessionTests.test_no_agent_may_be_enrolled_as_a_human_or_claim_as_one",
                 "test_agent_queue.AgentQueueTests.test_work_waiting_on_a_person_is_offered_to_nobody",
                 "test_agent_queue.AgentQueueTests.test_an_agent_is_not_told_about_work_belonging_to_another_role",
                 "test_agent_queue.AgentQueueTests.test_the_listing_carries_no_task_content",
                 "test_agent_runner.EntryPointTests.test_an_exposed_secret_is_refused_unless_the_host_is_declared_unable",
                 "test_agent_runner.EntryPointTests.test_a_declared_unprotected_host_gets_a_private_copy_of_the_same_secret",
                 "test_agent_runner.EntryPointTests.test_the_copy_does_not_pretend_the_host_is_safe",
                 "test_provider_roster.RosterTests.test_a_roster_cannot_introduce_a_provider_the_engine_would_refuse",
                 "test_provider_roster.RosterTests.test_a_roster_cannot_claim_a_model_that_did_not_answer",
                 "test_provider_roster.EngineRosterTests.test_a_roster_cannot_smuggle_a_provider_past_the_engine",
                 "test_consultations.ConsultationTests.test_a_consultation_leaves_no_task_no_approval_and_no_request_behind",
                 "test_consultations.ConsultationTests.test_nothing_in_this_module_reaches_the_state_machine",
                 "test_consultations.ConsultationTests.test_only_the_role_the_question_was_put_to_may_answer_it",
                 "test_consultations.ConsultationApiTests.test_the_window_cannot_answer_a_question_itself",
                 "test_consultations.ConsultationServiceTests.test_an_agent_cannot_answer_for_a_role_it_was_not_enrolled_for",
                 "test_agent_api.EnrolmentTests.test_no_agent_is_enrolled_as_a_human",
                 "test_agent_api.EnrolmentTests.test_the_secret_is_written_private",
                 "test_agent_api.EnrolmentTests.test_enrolling_twice_refuses_rather_than_replacing_a_secret",
                 "test_agent_api.EnrolmentTests.test_the_command_line_prints_the_path_and_never_the_secret"),
    ...
    {"id": "SEC-05",
     ...
     "offline": ("test_boundaries.BoundaryTests.test_no_external_effect_before_action_approval",
                 ...
                 "test_agent_processes.LifecycleApiTests.test_no_route_takes_an_image_a_command_or_a_path",
                 "test_agent_processes.LifecycleApiTests.test_unsupported_verbs_are_refused",
                 "test_agent_processes.LifecycleTests.test_a_field_this_does_not_know_about_is_refused_rather_than_ignored",
                 "test_agent_processes.LifecycleTests.test_a_name_that_is_not_an_agent_name_never_reaches_docker",
                 "test_agent_processes.LifecycleTests.test_no_credential_and_no_store_path_reach_the_container"),
     ...
     "deferred": ("Destructive, privilege, infrastructure, production and external-communication operations are not implemented, so their approval paths are unexercised.",
                  "Starting an agent container is exercised against a fake daemon offline and against a real one by hand; the Docker lane gates task execution, not agent lifecycle.")},
    {"id": "SEC-06",
     ...
     "offline": ("test_boundaries.BoundaryTests.test_secrets_redacted_and_title_rejected",
                 "test_consultations.ConsultationTests.test_text_that_looks_like_a_credential_is_redacted_and_said_to_be",
                 ...
                 "test_dispatch.FetchTests.test_the_credential_goes_with_every_read"),
     "docker": (), "other_stages": ("tests/test_ui_*.cjs", "browser"),
