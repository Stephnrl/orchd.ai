...
CRITERIA = (
    {"id": "SEC-01",
     ...
     "deferred": ("The single local operator is trusted; no multi-user authorization or corporate identity is exercised.",
                  "Agent sessions scope work by role but do not authenticate the caller: any local process could claim any role, so they schedule cooperatively rather than authorize.")},
    {"id": "SEC-02",
