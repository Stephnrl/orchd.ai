...
| 7. GitHub integration | Offline request preview, ref comparison and conservative PR reconciliation classifier; platform actions still simulated; no live PR creation |
...
The latest full offline run completed 167 Python tests: 162 passed and five expected
